...
; Filament Sensor
M591 P2 D0 C"e0stop" S1                         ; configure Filament sensor connected to E0 Endstop - Change S1/S0 to turn on / off filament monitor


; Z-Probe
M558 P8 C"zprobe.in" H5 F120 T6000              ; Set Z probe type mini ir sensor			
G31 P500 X18 Y-38 Z3.00						    ; set Z probe trigger value, offset and trigger height
M557 X20:315 Y1:286 P3							; define mesh grid P6 hace 6 malla de 6x6
