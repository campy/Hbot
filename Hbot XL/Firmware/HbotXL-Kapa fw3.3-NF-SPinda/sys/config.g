...
M92 X80.00 Y80.00 Z400.00 E720.00				; set steps per mm
M566 X500.00 Y500.00 Z60.00 E600.00				; set maximum instantaneous speed changes (mm/min)
M203 X18000.00 Y18000.00 Z800.00 E3600.00		; set maximum speeds (mm/min)
M201 X2000.00 Y2000.00 Z400.00 E600.00			; set accelerations (mm/s^2)
M204 P1200.0 T5000.0                            ; set print and travel accelerations (mm(s^2)
M566 E300						;300	  ; Set maximum instantaneous speed changes (JERKS) (mm/min) ONLY EXTRUDER
...
M208 X328 Y328 Z400 S0							; set axis maxima

; Definimos Leadscrews para el Z_Tilt
M671 X-58.90:438.14 Y164:164 S5			        ; leadscrews at left (connected to Z) and right (connected to E1) of X axis ---	S Ajustarlo segun sensibilidad del probe

; Endstops
M574 X1 S1 P"!xstop"							; configure active-low endstop for low end on X via pin xstop
M574 Y2 S1 P"!ystop"							; configure active-low endstop for high end on Y via pin ystop
;574 Z1 S0										; no need, So not used anymore

; Filament Sensor
M98 P"0:/sys/00-Functions/FilamentsensorStatus"

; Z-Probe
M558 P5 C"^zprobe.in" H1.5 F600 T9000 A3 S0.03   ; Set Z probe type mini ir sensor			
G31 P500 X0 Y28 Z0					         ; set Z probe trigger value, offset and trigger height
M557 X10:320 Y40:310 P3						    ; define mesh grid P6 hace 6 malla de 6x6
...
M207 S1.2 R0 F2400 Z0							; Firmware retraction
